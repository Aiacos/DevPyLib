    ...
    def deform(self, block, geoItr, matrix, index):
        ...
        if envelopeVal != 0:
            ...
            if not inColliderMesh.isNull():
                ...
                bbox.expand(OpenMaya.MPoint(colliderBoundingBoxMinVal[0], colliderBoundingBoxMinVal[1],
                                            colliderBoundingBoxMinVal[2]))
                bbox.expand(OpenMaya.MPoint(colliderBoundingBoxMaxVal[0], colliderBoundingBoxMaxVal[1],
                ...
                hitBary2 = None
                tolerance = 0.0001
                floatVec = OpenMaya.MFloatVector(0, 1,
                ...
                for num in range(length):
                    ...
                    if bbox.contains(point):
                        ...
                        inColliderFn.allIntersections(floatPoint, floatVec, faceIds, triIds, idsSorted, space, maxParam,
                                                      testBothDirs, accelParams, sortHits, hitPoints, hitRayParams,
                                                      hitFaces, hitTriangles, hitBary1, hitBary2, tolerance)
