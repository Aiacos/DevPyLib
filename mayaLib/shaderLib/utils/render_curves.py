        ...
        for cv in ctrl_list:
            ...
            for cv_shape in cv_shape_list:
                ...
                try:
                    ...
                    color = []
                    for channel in rgb:
                        color_channel = pm.getAttr(
                            str(cv.getShape().name()) + f".overrideColor{channel}"
                        )
                ...
                surface_shader = shader_base.build_surfaceshader(
                    shaderName=shader_name, color=(rgb_color[0], rgb_color[1], rgb_color[2])
                )
