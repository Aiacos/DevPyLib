"""Mathematical functions for fluid property calculations.

Provides mathematical utility functions including repartition functions
and other calculations used for configuring fluid simulation properties.
"""
